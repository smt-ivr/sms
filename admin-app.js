...
// =====================================
// לוגיקת הרשמה מורחבת (ותיקון באג האימייל)
// =====================================
...
// פונקציית עזר לבדיקת תקינות אימייל חכמה וסלחנית
...
async function loadAdminView(view) {
    ...
    // ... שאר הראוטים נשארים אותו דבר (logs, settings)
    if(view === 'logs') {
